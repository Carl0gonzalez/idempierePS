...
Script de provision para instalar **iDempiere 12** de forma rapida y guiada usando **OpenJDK 17**, **PostgreSQL 15** y configuracion automatica del entorno.
...
Si necesitas otra rama, reemplaza `12-arm` por la rama correspondiente:
...
- Descarga automaticamente el paquete servidor de iDempiere 12 usado por esta rama.
